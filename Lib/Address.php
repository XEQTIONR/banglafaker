...
{
    protected static $cityPrefix = ['দক্ষিন', 'পূর্ব', 'পশ্চিম', 'উত্তর', 'নতুন', 'লেইক', 'পোর্ট', 'কাটা'];
    protected static $citySuffix = ['টাউন', 'তলা', 'হাট', 'খানা', 'মোর'];
    ...
    {
        return static::randomElement(self::$citySuffix);
    }
    ...
    {
        return Number::getBanglaNumber(self::numberBetween(1, 100));
    }
